...
class GestureHandler {
    ...
    private fun getFloatArrayOfResults(context: Context, byteBuffer: ByteBuffer): FloatArray {
    ...
    @VisibleForTesting
    internal fun getIndexOfMaxValue(array: FloatArray): Int {
        var maxIndex = 0
    ...
    private fun drawToBitmap(context: Context, canvasSize: Size, lines: List<Line>): Bitmap {
    ...
    @VisibleForTesting
    internal fun getByteBufferFromBitmap(bitmap: Bitmap): ByteBuffer {
    ...
    @VisibleForTesting
    internal fun Bitmap.trimBorders(): Bitmap {
    ...
    @VisibleForTesting
    internal fun Bitmap.addWhiteSpace(): Bitmap {
