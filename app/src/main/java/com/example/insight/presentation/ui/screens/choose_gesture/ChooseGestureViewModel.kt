...
import com.example.insight.presentation.ui.screens.drawing.DrawingUiState
...
class ChooseGestureViewModel(
        ...
        textToSpeech = TextToSpeech(
            ...
            if (it == TextToSpeech.SUCCESS) {
                textToSpeech.let { txtToSpeech ->
                    ...
                    txtToSpeech.speak(
                        "Please choose a gesture to assign an app to.",
    ...
    fun textToSpeechSpeak(message: String) {
        stopTextToSpeech()
        textToSpeech.speak(
            message,
            TextToSpeech.QUEUE_ADD,
